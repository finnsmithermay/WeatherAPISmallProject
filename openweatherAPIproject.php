...
if(is_numeric(substr($city, 0, 1))){
  ...
  $string = "http://api.openweathermap.org/data/2.5/weather?id=".$city."&units=metric&appid=dfaa52617aef39c0111038777aa55c6d";
}else{
  $string = "http://api.openweathermap.org/data/2.5/weather?q=".$city."&units=metric&appid=dfaa52617aef39c0111038777aa55c6d";
